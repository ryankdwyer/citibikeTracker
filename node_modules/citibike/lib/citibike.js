...
function Citibike( options ) {
    ...
    this.defaults = {
        ...
        stationsURL:           '/v1/station/list',
        updatesURL:            '/v1/station/updates'
    };
...
Citibike.prototype.getUpdates = function( params, callback ) {
    var url = this.options.restBase + this.options.updatesURL;
    this.get(url, params, function(data) {
      callback(data);
    });
    return this;
